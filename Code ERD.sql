...
CREATE DATABASE unisecure_research_cloud_db
...
CREATE TABLE SERVER_ROOM(
    serverRoomID VARCHAR(10) PRIMARY KEY,
...
CREATE TABLE SERVER(
    ...
    serverRoomID VARCHAR(10) NOT NULL,
    ...
    CONSTRAINT fk_server_room
        FOREIGN KEY(serverRoomID)
        REFERENCES SERVER_ROOM(serverRoomID)
        ON UPDATE RESTRICT
        ON DELETE RESTRICT
);
...
CREATE TABLE VIRTUAL_SERVER(
    ...
    CONSTRAINT fk_virtual_physical
...
CREATE TABLE CREDENTIALS(
    credentialID VARCHAR(10) PRIMARY KEY,
...
CREATE TABLE SERVICE_PERMISSION(
    servicePermissionID VARCHAR(10) PRIMARY KEY,
    userID VARCHAR(10) NOT NULL,
    ...
    CONSTRAINT fk_permission_service
...
('U001','IT','Information Technology','PO101','0901234567'),
('U002','HR','Human Resource','PO102','0902345678'),
('U003','FIN','Finance','PO103','0903456789');

-- SERVER ROOM
INSERT INTO SERVER_ROOM VALUES
('SR001','Main Server Room'),
('SR002','Backup Server Room');
...
('DV001','US001','Dell','Latitude 5520','2025-01-10'),
('DV002','US002','HP','EliteBook 840','2025-02-01'),
('DV003','US003','Apple','MacBook Air','2025-03-01');

-- FIXED DEVICE
INSERT INTO FIXED_DEVICE VALUES
('DV001','192.168.1.100','AA:BB:CC:11:22:33','Building A','101');

-- MOBILE DEVICE
INSERT INTO MOBILE_DEVICE VALUES
('DV002','SN1001','Windows','11',TRUE,TRUE),
...
-- PHYSICAL SERVER
INSERT INTO PHYSICAL_SERVER VALUES
('SV001');

-- VIRTUAL SERVER
INSERT INTO VIRTUAL_SERVER VALUES
('SV002','SV001');

-- SERVICE
INSERT INTO SERVICE VALUES
('SE001','SV001','Email Service','2025-01-01'),
('SE002','SV002','Database Service','2025-01-15');

-- CREDENTIALS
INSERT INTO CREDENTIALS VALUES
('CR001','US001','admin','123456789','2025-01-01'),
('CR002','US002','binh','987654321','2025-01-05'),
('CR003','US003','cuong','456789123','2025-01-10');

-- SERVICE PERMISSION
INSERT INTO SERVICE_PERMISSION VALUES
('SP001','US001','SE001','2025-02-01'),
('SP002','US002','SE002','2025-02-10'),
('SP003','US003','SE001','2025-02-20');

-- DEVICE SERVER APPROVAL
INSERT INTO DEVICE_SERVER_APPROVAL VALUES
('AP001','DV001','SV001','2025-03-01',NULL),
